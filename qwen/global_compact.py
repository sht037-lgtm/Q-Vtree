"""
Q-VTree Global-Compact variant for Qwen2.5-VL.
...
def run_tree_inference(
    ...
    """Q-VTree Global-Compact pipeline. Pass 2 uses original image + compact image."""
    device = next(model.parameters()).device
...
class Qwen2_5_VLForConditionalGenerationWithTree(Qwen2_5_VLForConditionalGeneration):
    """
    Qwen2.5-VL with Q-VTree Global-Compact visual token selection.

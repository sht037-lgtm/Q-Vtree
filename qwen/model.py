...
class Qwen2_5_VLModelWithTree(Qwen2_5_VLModel):
    ...
    def forward(
        ...
        if pixel_values is not None:
            ...
            hook_handle = self.language_model.layers[4].self_attn.register_forward_hook(
                make_hook(4), with_kwargs=True
            )
            ...
            captured = layer_capture[4]
            q = captured['q']
            k = captured['k']
            pos_emb = captured['pos_emb']

            attn_module = self.language_model.layers[4].self_attn

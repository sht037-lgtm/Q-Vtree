    ...
    def forward(
        ...
        **kwargs,
        ...
        if pixel_values is not None:
            ...
            # safety floor
            num_selected_total = max(num_selected_total, 32)

            new_input_ids = (
                    input_ids_list[: start_idx + 1]
                    + [vision_token_id] * num_selected_total
                    + input_ids_list[end_idx:]
            )

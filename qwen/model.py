...
class Qwen2_5_VLModelWithTree(Qwen2_5_VLModel):
    ...
    def forward(
        ...
        if pixel_values is not None:
            ...
            # 4. First forward: hook layer 20 to get Q, K + RoPE
            ...
            hook_handle = self.language_model.layers[20].self_attn.register_forward_hook(
                make_hook(20), with_kwargs=True
            )
            ...
            captured = layer_capture[20]
            q = captured['q']
            k = captured['k']
            pos_emb = captured['pos_emb']

            attn_module = self.language_model.layers[20].self_attn
